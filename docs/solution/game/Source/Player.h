...
private:
    ...
    // ----- ANIMATION SETS ----- //
    Animation* animPlayerWalkUp = new Animation();
    Animation* animPlayerWalkDown = new Animation();
    Animation* animPlayerWalkLeft = new Animation();
    Animation* animPlayerWalkRight = new Animation();
    // -------------------------- //
